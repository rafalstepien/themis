from src.engine.adapters.outbound.llm.dto import (
...
from src.engine.adapters.outbound.llm.mappers import to_domain
from src.engine.domain.models import Change, MergeRequest, ReferenceKind
...
def test_anchor_resolved_for_added_line():
    comment = CommentDTO(
        content="float price",
        references=[],
        file_path="src/catalog/pricing.py",
        line=11,
    )
