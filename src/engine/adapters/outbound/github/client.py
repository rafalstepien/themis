...
class GitHubClient(GitProviderPort):
    ...
    def post_general_comment(self, comment: ReviewComment) -> None:
        ...
        url = (
            f"{self.BASE_API_URL}/repos/{self.owner}/{self.repo}/issues/{self.pull_number}/comments"
        )
    ...
    def post_inline_comment(self, comment: ReviewComment, diff_refs: DiffRefs) -> None:
        ...
        url = (
            f"{self.BASE_API_URL}/repos/{self.owner}/{self.repo}/pulls/{self.pull_number}/comments"
        )
